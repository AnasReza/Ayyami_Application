...
import 'package:ayyami/navigation/custom_fab.dart';
          ...
          children: [
           ...
           GestureDetector(child: Column(
             ...
             children: [
               ...
               SizedBox(height: 9.h),
               Text(text['supplications']!,style: TextStyle(color: darkMode ? AppDarkColors.headingColor : AppColors.headingColor),)
             ],
           ),onTap: (){
             tappingIndex(1);
           },),
            ...
            GestureDetector(child:  Container(
              width: 70,
              height: 70,
              decoration: BoxDecoration(gradient: AppColors.bgPinkishGradient, shape: BoxShape.circle),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  SvgPicture.asset(
           ...
           GestureDetector(child: Column(
             ...
             children: [
               ...
               SizedBox(height: 9.h),
               Text(text['prayer']!,style: TextStyle(color: darkMode ? AppDarkColors.headingColor : AppColors.headingColor),)
             ],
           ),onTap: (){
             tappingIndex(3);
           },),
            GestureDetector(child:Column(
              ...
              children: [
                ...
                SizedBox(height: 9.h),
                Text(text['settings']!,style: TextStyle(color: darkMode ? AppDarkColors.headingColor : AppColors.headingColor),)
              ],
            ),onTap: (){
              tappingIndex(4);
            },)
