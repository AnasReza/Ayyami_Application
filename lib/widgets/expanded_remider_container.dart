                    ...
                    children: [
                      ...
                      CustomSwitch1(
                        ...
                        onChanged: ((value) {
                          ...
                          List<Map<String, dynamic>> medicineMap =
                              provider.getMap;
                          var userProvider =
                            ...
                            if (medicineMap.isNotEmpty) {
                              for (var subMap in medicineMap) {
                                SendNotification().medicineNotificationTime(
                                    subMap['timeList'],
                                    subMap['medicine_name'],
                                    provider);
                              }
                            }

                            UsersRecord()
                                .updateShowMedicine(userProvider.getUid, true);
                          } else {
                            for (var subMap in medicineMap) {
                              SendNotification().cancelMedicineNotification(
                                  subMap['timeList'], provider);
                            }
                            UsersRecord()
                                .updateShowMedicine(userProvider.getUid, false);
                          }
                        }),
                                      ...
                                      return Padding(
                                        ...
                                        child: MedicineContainer(
                                          medicineTime: provider.getMap[index]
                                              ['timeList'],
                                          medicinetitle: provider.getMap[index]
                                              ['medicine_name'],
