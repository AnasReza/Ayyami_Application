...
import '../screens/Login_System/account_create.dart';
...
class SideBar extends StatelessWidget {
  ...
  SideBar(this.textList, this.invite, this.about_us, this.logout, this.delete, this.delete_question,
      this.yes, this.no, this.deleting,
      {super.key});
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                GestureDetector(
                  child: SideBarBottomView(logout, AppImages.logoutIcon, darkMode),
                  onTap: () {
                    var likoriaProvider = Provider.of<LikoriaTimerProvider>(context, listen: false);
                    var mensesProvider = Provider.of<MensesProvider>(context, listen: false);
                    var postProvider = Provider.of<PostNatalProvider>(context, listen: false);
                    ...
                    Provider.of<MedicineProvider>(context, listen: false).resetValue();
                    Provider.of<NamazProvider>(context, listen: false).resetValue();

                    LikoriaTracker().resetLikoria(likoriaProvider);
                    MensesTracker().resetTracker(mensesProvider);
                    PostNatalTracker().resetValue(postProvider);
                    ...
                    Navigator.pushAndRemoveUntil(
                        context,
                        MaterialPageRoute(builder: (c) => const account_create()),
                        (route) => false);
                  },
                ),
                const SizedBox(
                ...
                GestureDetector(
                  child: SideBarBottomView(delete, AppImages.deleteAccountIcon, darkMode),
                  onTap: () {
                    showDialog(
                        context: context,
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  user?.delete().then((value) {
                                    UsersRecord().deleteAccount(provider.getUid).then((value) {
                                      var likoriaProvider =
