...
class LikoriaTracker {
  ...
  void startLikoriaTimer(LikoriaTimerProvider likoriaProvider, String uid,
      Timestamp startTime, int colorInt) {
  ...
  void startLikoriaTimerAgain(
      LikoriaTimerProvider likoriaProvider, int milliseconds) {
  ...
  void stopLikoriaTimer(LikoriaTimerProvider likoriaProvider) {
    ...
    //TODO: change Timestamp.now to what needed
    TuhurRecord.uploadTuhurEndTime(tuhurID, daysCount, hoursCount, minutesCount,
        secondsCount, Timestamp.now());
