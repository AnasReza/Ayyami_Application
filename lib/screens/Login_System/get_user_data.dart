...
class SetPassword extends StatefulWidget {
  ...
  const SetPassword(
      {super.key, required this.contactNumber, required this.userId});
...
class _SetPasswordState extends State<SetPassword> {
  ...
  //  _SetPasswordState(contactNumber, userId);
                      ...
                      if (imageData == null) {
                        await rootBundle.load(assetsPath).then((bytes) async {
                          ...
                          FirebaseFirestore.instance
                            ...
                            'contact_no': widget.contactNumber,
                            "imgUrl": newUrl,
                            'uid': uid
                          }).then((value) {
                        ...
                        FirebaseFirestore.instance
                          ...
                          UsersRecord()
                              .updateShowNamaz(uid, 'show_fajar', true);
                          UsersRecord()
                              .updateShowNamaz(uid, 'show_sunrise', true);
                          UsersRecord()
                              .updateShowNamaz(uid, 'show_duhur', true);
                          UsersRecord().updateShowNamaz(uid, 'show_asr', true);
                          UsersRecord()
                              .updateShowNamaz(uid, 'show_maghrib', true);
