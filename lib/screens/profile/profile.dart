...
class _ProfilePageState extends State<ProfilePage> {
  ...
  getQuestionsAnswer(
      DocumentSnapshot<Map<String, dynamic>> value, String lang) {
                          ...
                          child: GradientButton(
                            ...
                            onPressedButon: () {
                              ...
                              if (name.isNotEmpty) {
                                if (nameChange != name) {
                                  UsersRecord()
                                      .changeName(provider.getUid, nameChange)
                                      .then((value) {
                                    setState(() {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          QuestionAnswerView(
                              question: text['Are_you_Beginner']!,
                              answer: beginner,
                              darkMode: darkMode),
                          QuestionAnswerView(
                              question: text['Are_you_Married']!,
                              answer: married_unmarried,
                              darkMode: darkMode),
                          QuestionAnswerView(
                              question: text['Are_you_pregnant']!,
                              answer: are_pregnant,
                              darkMode: darkMode),
                          QuestionAnswerView(
                              question: text['which_pregnancy']!,
                              answer: which_pregnancy,
                              darkMode: darkMode),
                          QuestionAnswerView(
                              question: text['how_many_weeks_pregnant']!,
                              answer: week_pregnant,
                              darkMode: darkMode),
                          QuestionAnswerView(
                              ...
                              darkMode: darkMode),
                          QuestionAnswerView(
                              question: text['menstrual_period']!,
                              answer: menstrual_period,
                              darkMode: darkMode),
                          QuestionAnswerView(
                              question: text['is_it_bleeding']!,
                              answer: is_it_bleeding,
                              darkMode: darkMode),
                          QuestionAnswerView(
                              question: text['Post_natal_cycle']!,
                              answer: post_natal_bleeding,
                              darkMode: darkMode),
                          QuestionAnswerView(
                              question: text['starting_time']!,
                              answer: start_time,
                              darkMode: darkMode),
                          QuestionAnswerView(
                              question: text['Stoping_time']!,
                              answer: stop_time,
                              darkMode: darkMode),
                          QuestionAnswerView(
