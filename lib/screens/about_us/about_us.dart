              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Text(
                      'about_us'.tr,
                      style:  TextStyle(color: darkMode!?AppDarkColors.headingColor:AppColors.headingColor, fontWeight: FontWeight.w400, fontSize: 16),
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    Row(
                      ...
                      children: [
                        Text(
                          'verified_by'.tr,
                          style: TextStyle(color: darkMode!?AppDarkColors.headingColor:AppColors.headingColor, fontSize: 20, fontWeight: FontWeight.w700),
                        ),
