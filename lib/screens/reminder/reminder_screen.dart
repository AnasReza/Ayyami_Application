                                ...
                                children: [
                                  ...
                                  CustomSwitch1(
                                    ...
                                    onChanged: ((value) {
                                      if (!value) {
                                        SendNotification()
                                            .sadqaNotificationTime(int.parse(
                                                provider.getSadqaAmount
                                                    .toString()));
                                      } else {
                                        SendNotification()
                                            .cancelSadqaNotificationTime();
                                      }
                                      provider.setShowSadqa(value);
                                      UsersRecord().updateShowSadqa(
                                          provider.getUid, value);
                                    }),
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    ...
                                    onTap: () {
                                      ...
                                      provider.setSadqaAmount(
                                          int.parse(sadqaString));
                                    },
                                  )
                                ],
                              )
                    ...
                    returnvalue: (value) {
                      try {
                        if (!value) {
                          ...
                          var map =
                              Utils().assumptionOfMenses(provider, startTime);
                          DateTime startDateTime =
                              DateTime.parse(map['start'].toString());

                          SendNotification()
                              .cycleNotificationTime(startDateTime);
