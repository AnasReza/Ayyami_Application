                  ...
                  GradientButton(
                    ...
                    onPressedButon: () {
                      ...
                      if (pressedInt == 1) {
                        ...
                        try {
                          bool ifDataInitialized =
                              provider.getTuhurData.length > 0;
                        } catch (e) {
                          DateTime lastTuhurHasStarted = widget.start_date
                              .subtract(const Duration(days: 15));
                          TuhurTracker().addPreviousQuestionTuhur(
                              provider.getUid,
                              Timestamp.fromDate(lastTuhurHasStarted),
