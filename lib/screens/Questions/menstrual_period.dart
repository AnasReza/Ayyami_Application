                        ...
                        onPressedButon: () {
                          ...
                          if (Startdate != null &&
                            ...
                            var lastMensesStartDate = DateTime(
                                ...
                                Startdate!.minute,
                                0);
                            var lastMensesEndDate = DateTime(
                                Enddate!.year,
                                Enddate!.month,
                                Enddate!.day,
                                Endtime!.hour,
                                Enddate!.minute,
                                0);
                            var diff = Utils.timeConverter(lastMensesEndDate
                                .difference(lastMensesStartDate));
                            if (diff['days']! < 3) {
                              toast_notification()
                                  .toast_message(text['less_than_3_days']!);
                            } else {
                              ...
                              var endTimeStamp =
                                  Timestamp.fromDate(lastMensesEndDate);
                              int? days = diff['days'];
