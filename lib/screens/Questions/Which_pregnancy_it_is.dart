              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                          child: Image.asset("assets/images/left_arrow.png",color: widget.darkMode?AppDarkColors.headingColor:AppColors.headingColor,),
                          onTap: () {
                            _decrementCount();
                          }),
                      ...
                      const SizedBox(width: 60),
                      InkWell(
                          child: Image.asset("assets/images/right_arrow.png",color: widget.darkMode?AppDarkColors.headingColor:AppColors.headingColor,),
                          onTap: () {
                            _incrementCount();
                          }),
                    ],
