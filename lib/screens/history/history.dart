...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  getMensesData(String uid, String timeLimit) {
    ...
    MensesRecord()
        .getAllMensesRecordLimited(
            uid, DateTime.now().subtract(Duration(days: days)))
        .listen((mensesEvent) {
      TuhurRecord()
          .getAllCompletedTuhurRecordLimit(
              uid, DateTime.now().subtract(Duration(days: days)))
          .listen((tuhurEvent) {
        List<QueryDocumentSnapshot<Map<String, dynamic>>> newtuhurList = [];
        List<QueryDocumentSnapshot<Map<String, dynamic>>> newMensesList = [];
        allTuhur.clear();
        allMenses.clear();
        allMenses = mensesEvent.docs;
        allTuhur = tuhurEvent.docs;
        for (QueryDocumentSnapshot<Map<String, dynamic>> map in allMenses) {
          try {
            var endTime = map['end_time'];
            newMensesList.add(map);
          } catch (e) {
            print('${map.id} end time nahi hai');
          }
        }
        if (newMensesList.isNotEmpty) {
          allMenses.clear();
          allMenses = newMensesList;
        }
        ...
        if (newtuhurList.isNotEmpty) {
          allTuhur.clear();
          allTuhur = newtuhurList;
        }
        print(allMenses.length);
        print(allTuhur.length);
                    ...
                    SliverFillRemaining(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () async {
                                  print(
                                      '${selectedDataList.length} length of selected data list');
                          ...
                          Directionality(
                            textDirection: provider.getLanguage == 'ur'
                                ? TextDirection.rtl
                                : TextDirection.ltr,
                            child: Row(
                          ...
                          Visibility(
                            visible:
                                allTuhur.isNotEmpty && allMenses.isNotEmpty,
                            replacement: Text(
                              text['no_record']!,
                              style: TextStyle(
                                  color: darkMode
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (c, index) {
                                      ...
                                      Timestamp startStamp =
                                          allMenses[index]['start_date'];
                                      print(allMenses[index]['start_date']);
                                          ...
                                          GestureDetector(
                                            child: HistoryCategoryBox(
                                              ...
                                              returnID: (data, value) {
                                                ...
                                                print(
                                                    '${selectedDataList.length} selectedDataList length from menses');
                                              },
                                            ),
                                            onTap: () {
                                              print(
                                                  '${allMenses.length} length on click');
                                              nextScreen(
                                                  context,
                                                  HistoryDetails(
                                                      text['menses']!,
                                          ...
                                          GestureDetector(
                                            child: HistoryCategoryBox(
                                              ...
                                              returnID: (data, value) {
                                                ...
                                                print(
                                                    '${selectedDataList.length} selectedDataList length from tuhur');
                                              },
                                            ),
                                            onTap: () {
                                              nextScreen(
                ...
                child: pw.Column(
                  children: [
                    pw.Align(
                        ...
                        child: pw.SvgImage(
                            svg: app_logo, width: 249.6.w, height: 78.4.h)),
                    ...
                    pw.Container(
                      padding: const pw.EdgeInsets.all(5),
                      decoration: pw.BoxDecoration(
                          color: const PdfColor.fromInt(0xFFD88DBC),
                          borderRadius: pw.BorderRadius.circular(5)),
                      child: pw.Column(
